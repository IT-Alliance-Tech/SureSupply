...
const WhyChooseUs = () => {
  const points = [
    ...
    },
    {
      ...
      headline:
        "Digital Tools for Seamless Manufacturing & Supply Chain Management",
      description: [
  ...
  const nextSlide = (isMobile = false) => {
    if (isMobile && sliderRefMobile.current)
      sliderRefMobile.current.slickNext();
    else if (!isMobile && sliderRefDesktop.current)
      ...
      <div className="block md:hidden w-full text-center relative">
        ...
        <div className="mb-8 px-4">
          ...
          <p className="text-gray-600 mt-3 text-base sm:text-lg leading-relaxed">
            Your Trusted Partner for Precision Manufacturing & Supply Chain
            Excellence.
          </p>
        </div>
        ...
        <div className="relative flex flex-col items-center justify-center mb-10">
          ...
          {/* Slider */}
          <div className="w-[90%] max-w-[360px] overflow-hidden flex items-center justify-center">
          ...
          <div className="w-[80%] max-w-[280px] overflow-hidden h-[600px] flex items-center">
            <Slider ref={sliderRefDesktop} {...settingsDesktop}>
              {points.map((point, index) => (
                ...
                >
                  <div className="w-48 h-48 relative rounded-xl overflow-hidden shadow-lg m-5 mx-12">
                    <Image
                      src={point.image}
                      alt={point.title}
                      fill
